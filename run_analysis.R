...
# Create a DF that is a subset of the "all_rows" DF.  Include columns: "subject_id", "activity", and any column containing the strings "mean" or "std()".

print("Subset and Sumarize...")
...
write.table(sum_df, file="HARUS_tidy_subset.txt", sep=" ", row.names=FALSE, quote=FALSE)

print("UCI HAR Tidy Subset Script Completed!")
